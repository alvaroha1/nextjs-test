...
import styles from '../styles/SortedTable.module.css'
...
function SortButton({ sortOrder, columnKey, sortKey, onClick }: {
  ...
  return <button className={`${sortKey === columnKey && sortOrder === "desc" ? "sort-button sort-reverse": "sort-button"}`} onClick={onClick}>🔼</button>
}
